  ...
  (function() {
    (tracking.Image = {}),
        ...
        for (var s = 0; n > s; s++)
          for (var g = 0; r > g; g++) {
            ...
            if (
              ...
              var u = h - 4 * r,
                f = ~~(0.299 * t[u] + 0.587 * t[u + 1] + 0.114 * t[u + 2]);
      ...
      (tracking.Image.grayscale = function(t, r, n, e) {
        for (
          var i = new Uint8ClampedArray(e ? t.length : t.length >> 2),
            a = 0,
            o = 0,
            c = 0;
          n > c;
      ...
      (tracking.Image.sobel = function(t, r, n) {
        ...
        for (
          var e = new Float32Array(r * n * 4),
            ...
            o = this.separableConvolve(t, r, n, i, a),
            c = this.separableConvolve(t, r, n, a, i),
            s = 0;
          s < e.length;
          s += 4
        ) {
  ...
  (function() {
    (tracking.ViolaJones = {}),
      ...
      (tracking.ViolaJones.detect = function(t, r, n, e, i, a, o, c) {
        ...
        for (
          var l = c[0], p = c[1], v = e * i, m = (v * l) | 0, y = (v * p) | 0;
          r > m && n > y;

        ) {
          for (var d = (v * a + 0.5) | 0, w = 0; n - y > w; w += d)
            for (var T = 0; r - m > T; T += d)
              (o > 0 && this.isTriviallyExcluded(o, s, w, T, r, m, y)) ||
                (this.evalStages_(c, k, u, f, w, T, r, m, y, v) &&
                  (h[g++] = { width: m, height: y, x: T, y: w }));
          (v *= i), (m = (v * l) | 0), (y = (v * p) | 0);
        }
          ...
          for (var e = t[n], i = 0; i < t.length; i++) {
            ...
            if (
              ...
              var o = Math.max(e.x, a.x),
                ...
                k = e.width * e.height,
                u = a.width * a.height;
              h / (k * (k / u)) >= this.REGIONS_OVERLAP &&
                h / (u * (k / u)) >= this.REGIONS_OVERLAP &&
                r.union(n, i);
            }
          }
  ...
  (function() {
    (tracking.Brief = {}),
      ...
      (tracking.Brief.match = function(t, r, n, e) {
        for (
          var i = t.length >> 1, a = n.length >> 1, o = new Array(i), c = 0;
          i > c;
          c++
        ) {
      ...
      (tracking.Brief.reciprocalMatch = function(t, r, n, e) {
        ...
        for (
          var a = tracking.Brief.match(t, r, n, e),
      ...
      (tracking.Brief.getRandomOffsets_ = function(t) {
        ...
        if (!this.randomImageOffsets_[t]) {
          for (
            var i = 0, a = new Int32Array(2 * this.N), o = 0;
            o < this.N;
            o++
          )
            (a[i++] =
      ...
      (tracking.ColorTracker.prototype.trackColor_ = function(n, e, i, a) {
        ...
        for (var d = 0; i > d; d++)
          for (var w = 0; e > w; w++)
            if (((y += 4), !f[y])) {
              for (
                o = 0, h = -1, v[++h] = y, v[++h] = d, v[++h] = w, f[y] = 1;
                h >= 0;
